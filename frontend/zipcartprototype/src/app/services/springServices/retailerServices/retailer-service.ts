...
export class RetailerService {
  ...
  private backendUrl: string = 'http://localhost:8080/api/retailer';
  // change to the below backend url while working with emulator
  private backendUrlEmulator: string = 'http://10.0.2.2:8080/retailer';
  // change to the below backend url while working with device where the 0.0.0.0 is the users IPV4 Address
  private backendUrlDevice: string = 'http://10.0.0.87:8080/retailer';
